#!/usr/bin/env python3
"""Build the exact-two paper-rc2 source freeze with the AMS/XeLaTeX profile.
...
SOURCE_DATE_EPOCH = "1785694327"  # 2026-08-02T18:12:07Z
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="no2-paper-rc2-") as temporary:
        work = Path(temporary)
