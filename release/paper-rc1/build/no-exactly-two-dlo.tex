...
theorem with altered hypotheses. The cited Lean 4 development formalizes
the exact-three theorem package \hyperref[ref:isthmus2026b]{Isthmus
2026b}; the exact-two engine and cut-rotation argument are not claimed
to be part of that formalization.
...
workflow for exploratory proof development, counterexample search,
drafting, and adversarial review. The author set the research
objectives, decided which candidate arguments to retain or reject,
reviewed and approved the final manuscript, and takes responsibility for
all mathematical claims and any remaining errors. AI systems are tools,
not authors.
